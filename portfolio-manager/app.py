...
display_cols = [
    "ticker", "name", "quantity", "buy_price", "price",
...
st.caption(
    "Per aggiungere o modificare posizioni, modifica data/portfolio.csv "
    "(direttamente su GitHub o via git) e ricarica la pagina."
)
