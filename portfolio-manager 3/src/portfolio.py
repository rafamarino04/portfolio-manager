...
def enrich_with_prices(df: pd.DataFrame) -> pd.DataFrame:
    ...
    Per strumenti non coperti da Yahoo Finance (tipicamente obbligazioni
    identificate da ISIN), se e' presente un valore in 'manual_price' viene
    usato quello al posto del prezzo live, e la riga viene marcata come
    'manuale' nella colonna price_source.
    """
    rows = []
